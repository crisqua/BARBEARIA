...
export class AdminUsersService {
   ...
   *
   * SEM cache aqui, de propósito (removido em 2026-09-23) — usuário é criado
   * por módulos fora do admin/ (professionals.service.ts, auth.service.ts),
   * então não dá pra invalidar direito sem acoplar módulos que não deveriam
   * se conhecer. `mapWithConcurrency` (abaixo) já resolve o problema real
   * (crash com muitos tenants).
   */
